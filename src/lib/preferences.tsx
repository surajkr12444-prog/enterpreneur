...
const COPY = {
  en: {
    ...
    businessLoans: 'Business Loans', emi: 'EMI Calculator', official: 'Official Portals',
    login: 'Login', signup: 'Sign Up', account: 'Account', logout: 'Logout',
    gatewayEyebrow: 'ONE PLACE FOR OPPORTUNITY',
    gatewayTitle: 'Government business schemes, matched to you.',
    gatewayBody: 'Sign in to discover business funding, eligibility, document checklists and guided official-portal steps.',
    ...
    loginBody: 'Access your profile, history and saved opportunities.', signupBody: 'Create one account for business schemes and guided applications.',
    splashLine: 'Schemes. Guidance. Clear next steps.',
    ...
    heroBadge: 'Personalised Business Scheme Matching',
    heroTitle: 'Government opportunities, made easier to understand and apply for.',
    heroBody: 'Udaan matches entrepreneurs to relevant government schemes and loans, explains eligibility and documents, then guides you to the official application portal.',
  },
  hi: {
    brandTag: 'सरकारी योजनाएँ',
    businessLoans: 'बिज़नेस लोन', emi: 'EMI कैलकुलेटर', official: 'आधिकारिक पोर्टल',
    login: 'लॉगिन', signup: 'साइन अप', account: 'अकाउंट', logout: 'लॉगआउट',
    gatewayEyebrow: 'अवसरों के लिए एक ही जगह',
    gatewayTitle: 'सरकारी बिज़नेस योजनाएँ — आपकी प्रोफ़ाइल के अनुसार।',
    gatewayBody: 'लॉगिन करके बिज़नेस फंडिंग, eligibility, दस्तावेज़ चेकलिस्ट और आधिकारिक पोर्टल की स्टेप-बाय-स्टेप गाइड पाएँ।',
    ...
    loginBody: 'अपनी प्रोफ़ाइल, हिस्ट्री और सेव किए गए अवसर देखें।', signupBody: 'बिज़नेस योजनाओं और गाइडेड आवेदन के लिए एक अकाउंट बनाएँ।',
    splashLine: 'योजनाएँ। मार्गदर्शन। साफ़ अगला कदम।',
    ...
    heroBadge: 'पर्सनलाइज़्ड बिज़नेस योजना मैचिंग',
    heroTitle: 'सरकारी अवसर समझना और आवेदन करना अब आसान।',
    heroBody: 'Udaan उद्यमियों को उनकी प्रोफ़ाइल के अनुसार सरकारी योजनाओं और लोन से मैच करता है, eligibility और documents समझाता है और आधिकारिक आवेदन पोर्टल तक मार्गदर्शन देता है।',
  },
  hinglish: {
    brandTag: 'Govt Schemes',
    businessLoans: 'Business Loans', emi: 'EMI Calculator', official: 'Official Portals',
    ...
    gatewayTitle: 'Govt business schemes — aapki profile ke hisaab se.',
    gatewayBody: 'Login karke business funding, eligibility, documents checklist aur official portal ki step-by-step guidance pao.',
    email: 'Email address', password: 'Password', name: 'Full name', continueEmail: 'Continue',
    ...
    loginBody: 'Profile, history aur saved opportunities access karo.', signupBody: 'Business schemes aur guided applications ke liye account banao.',
    splashLine: 'Schemes. Guidance. Clear next steps.',
    lang: 'Language', theme: 'Theme', light: 'Light', dark: 'Dark',
    ...
    heroBody: 'Udaan entrepreneurs ko relevant govt schemes aur loans se match karta hai, eligibility aur documents explain karta hai, aur official application portal par guide karta hai.',
  },
} as const;
