...
export default function StatsStrip() {
  ...
  const labels = language === 'hi' ? ['बिज़नेस योजनाएँ','आधिकारिक पोर्टल लिंक','भारत के राज्य + UT','औसत match समय'] : language === 'hinglish' ? ['Business schemes','Official portal links','States + UTs','Avg. match time'] : ['Business schemes','Official portal links','States + UTs','Avg. match time'];
  const stats = [['15',labels[0]],['100%',labels[1]],['28 + 8',labels[2]],['~90 sec',labels[3]]];
