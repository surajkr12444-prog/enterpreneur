const QUOTES = [
  ...
  {
    name: "Ayesha Khan",
    role: "Home-based food business owner, Bhopal",
    quote:
      "Udaan helped me compare business schemes, understand the documents I needed, and reach the official application portal without depending on an agent.",
  },
  {
    name: "Manjunath K.",
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-display text-3xl font-semibold tracking-tight sm:text-4xl">
            Built for entrepreneurs who need clearer access to government support.
          </h2>
        </div>
